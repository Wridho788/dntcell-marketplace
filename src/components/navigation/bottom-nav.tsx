              ...
              >
                <div className="relative">
                  ...
                  {item.badge && item.badge > 0 && (
                    <span className="absolute -top-1 -right-1 bg-accent-700 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">
                ...
                {isActive && (
                  <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-8 h-1 bg-primary-800 rounded-t-full" />
                )}
              </Link>
            )
          })}
